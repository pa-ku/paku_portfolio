...
export default function LangButton() {
    ...
    return (
        <div className='relative group animate-icons flex text-sm   items-center overflow-x-clip justify-center'>
            <button
                className={`${spanish ? 'translate-x-0' : ' translate-x-24'
            ...
            <button
                ...
                className={`flex gap-2 items-center justify-center absolute duration-300 ${spanish ? 'translate-x-24' : 'translate-x-0'
                    }`}
            >
                <img
