  ...
  es: [
    {
      ...
      text: "Inicié mi aventura en 2022 con el curso de Codo a Codo sobre PHP . Desde entonces, mi entusiasmo por la programación despegó 🚀, motivándome a aprender de forma autodidacta.",
    },
    {
      title: "¿Quién soy como desarrollador?",
      text: "Me defino como una persona empática, flexible y resolutiva. Con capacidad de adaptación a diferentes entornos. Valoro el optimismo y la colaboración en equipo.",
    },
    {
    ...
    },
    {
      ...
      text: "Me baso en la documentación oficial, recursos educativos como YouTube. Siempre aplicando en proyectos prácticos lo aprendido.",
    },
    {
      title: "Hobbies",
  ...
  eng: [
    {
      ...
      text: "I started my journey in 2022 with the Codo a Codo course on PHP. Since then, my passion for programming took off 🚀, motivating me to learn independently.",
    },
    {
      title: "Who am I as a developer?",
      text: "I define myself as an empathetic, flexible, and solution-oriented person. I have the ability to adapt to different environments. I value optimism and teamwork.",
    },
    {
    ...
    },
    {
      ...
      text: "I rely on official documentation, educational resources like YouTube. Always applying what I learn in practical projects.",
    },
    {
      title: "Hobbies",
      text: "Coding 💻 | Designing 🎨 | Camping 🏕 | Padel 🥎 | Guitar 🎸 | Cycle touring 🚲 | Climbing 🧗‍♂️",
    },
  ],
};
    ...
    <>
      <article className="space-y-3">
        ...
        <p className="text-lg dark:text-slate-400">
          {spanish ? ABOUT_ME.es : ABOUT_ME.eng}{" "}
        </p>

        {!moreAboutMe && (
          <button
            onClick={() => setMoreAboutMe(!moreAboutMe)}
            className="text-primary font-bold mt-5"
          >
            {spanish ? "Más sobre mi" : "More about me"}{" "}
          </button>
        )}

        {moreAboutMe &&
          spanish &&
          MORE_ABOUT_ME.es.map(({ title, text, li }) => (
        ...
        {moreAboutMe &&
          !spanish &&
          MORE_ABOUT_ME.eng.map(({ title, text, li }) => (
            <div className="animate-opacity">
              <p className="font-bold">{title} </p>
              <p className="dark:text-slate-400">{text && text} </p>
              <ol className="list-disc ml-5">
