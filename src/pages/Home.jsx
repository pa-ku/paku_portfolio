...
export default function Home() {
    return (
        <>
            <header className="h-40 bg-gradient-to-br flex items-start justify-center relative px-20 duration-500 dark:to-primary-700 dark:from-primary-500 from-primary-400 to-primary-600 z-10">
            </header>
